...
int main(int argc, char *argv[])
{
    ...
    pdApp.setStyleSheet("QHeaderView::section, QTableView QTableCornerButton::section{color: #fff; padding: 4px; border: 1px solid #444; background: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(80, 80, 80, 255), stop:1 rgba(90, 90, 90, 255)); }");
